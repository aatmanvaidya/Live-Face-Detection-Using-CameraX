...
class Overlay @JvmOverloads constructor(
    ...
    //setting up the parameter's for the detection box
    ...
    fun setFaces(faceList: List<Face>) {
        ...
        //The postInvalidate method notifies the system from a non-UIThread
        // and the View gets redrawn in the next event loop on the UIThread as soon as possible.
        postInvalidate()
    }
